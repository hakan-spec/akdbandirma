...
const AuthForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        if (error.message.includes('Supabase') || error.message.includes('sunucu')) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white shadow-xl rounded-lg p-8">
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-red-800 mb-1">Bağlantı Hatası</h3>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h3 className="font-medium text-blue-900 mb-2">Supabase Bağlantısı Aktif</h3>
            <p className="text-blue-700 text-sm">
              Uygulama gerçek Supabase veritabanına bağlı. Supabase'e kayıtlı kullanıcı bilgilerinizle giriş yapın.
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 text-center">
          <p className="text-gray-500 text-sm">
            Verileriniz Supabase veritabanında güvenle saklanır
          </p>
        </div>
      </div>
    </div>
